...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am a group management bot my official channel @sbtechz join all.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="HELP",
                                                                       ...
                                                                       url="t.me/sbtechzowner")],
                                                                                   [InlineKeyboardButton(text="ADD SB TechzBOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="official channel",
                                                                       url="t.me/sbtechz")
                                                                                 ]]))

    else:
        update.effective_message.reply_text(" lol i am alive.. join first @sbtechz ")
